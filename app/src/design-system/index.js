"use client";
// Barrel do Drop Color Design System.
// Os arquivos dentro de design-system/ são o bundle original, sem alteração.
// Este arquivo só existe para marcar a fronteira de client component do Next.
...
export { ModelCard } from "./components/commerce/ModelCard.jsx";
export { PlanCard } from "./components/commerce/PlanCard.jsx";
